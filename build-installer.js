...
/**
 * TonyCash Tool - Installer Builder
 * Creates executable installers for Windows (.exe) and macOS (.app/.dmg)
 */
...
console.log('🚀 TonyCash Tool - Building Installers...');
console.log('==========================================');
...
const config = {
  name: 'TonyCash Tool',
  version: '1.0.0',
  description: 'Instagram Growth Automation Tool',
  author: 'SocialGeekUSA',
  repository: 'https://github.com/socialgeekusa/tonycash-tool-ig.git',
...
class TonyCashInstaller {
  ...
  async downloadTonyCashTool() {
    ...
    try {
      ...
      execSync(\`git clone ${config.repository} "\${this.installDir}"\`, { 
        stdio: 'pipe',
...
fs.writeFileSync('installer.js', installerScript);

// Create package.json for installer
const installerPackage = {
  name: 'tonycash-tool-installer',
  ...
  build: {
    appId: 'com.socialgeekusa.tonycash-tool',
    productName: 'TonyCash Tool Installer',
    directories: {
      output: 'dist'
    },
    files: [
...
fs.writeFileSync('installer-package.json', JSON.stringify(installerPackage, null, 2));
...
<svg width="256" height="256" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
  <rect width="256" height="256" rx="50" fill="#667eea"/>
  <text x="128" y="140" font-family="Arial, sans-serif" font-size="80" font-weight="bold" text-anchor="middle" fill="white">TC</text>
  <text x="128" y="200" font-family="Arial, sans-serif" font-size="20" text-anchor="middle" fill="white">TonyCash Tool</text>
</svg>
`;
...
console.log('');
console.log('📦 Next steps to build installers:');
console.log('');
console.log('1. Install electron-builder:');
console.log('   npm install -g electron-builder');
console.log('');
console.log('2. Install dependencies:');
console.log('   npm install --package-lock-only --package-lock-file=installer-package-lock.json --prefix . electron');
console.log('');
console.log('3. Build Windows installer:');
console.log('   electron-builder --config installer-package.json --win');
console.log('');
console.log('4. Build macOS installer:');
console.log('   electron-builder --config installer-package.json --mac');
console.log('');
console.log('🎉 This will create:');
console.log('   - TonyCash-Tool-Setup-1.0.0.exe (Windows)');
console.log('   - TonyCash-Tool-1.0.0.dmg (macOS)');
